...
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_GAMMA1 = 141;

// depthが2乗されるので影響大きい
// 元の値 = 35
// [PARAM] min:20,max:60,step:3,interval:1,time_rate:1,fixed
PARAM_DEFINE PARAM_FUTILITY_AT_PARENT_NODE_GAMMA2 = 187;
...
PARAM_DEFINE PARAM_PRUNING_BY_HISTORY_DEPTH = 2;
...
PARAM_DEFINE PARAM_REDUCTION_BY_HISTORY = 2000;
...
PARAM_DEFINE PARAM_FUTILITY_MOVE_COUNT_ALPHA0 = 230;

// 元の値 = 500
// [PARAM] min:300,max:600,step:4,interval:1,time_rate:1,fixed
PARAM_DEFINE PARAM_FUTILITY_MOVE_COUNT_ALPHA1 = 480;

// 元の値 = 740
// [PARAM] min:500,max:2000,step:10,interval:1,time_rate:1,fixed
PARAM_DEFINE PARAM_FUTILITY_MOVE_COUNT_BETA0 = 720;

// 元の値 = 1000
// [PARAM] min:500,max:2000,step:5,interval:1,time_rate:1,fixed
PARAM_DEFINE PARAM_FUTILITY_MOVE_COUNT_BETA1 = 950;
...
PARAM_DEFINE PARAM_ASPIRATION_SEARCH_DELTA = 15;
