...
//				&& !is_promote(move)
	...
	Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode, bool skipEarlyPruning)
	{
		...
		bool valuableCaptureOrPawnPromotion, captureOrPawnPromotion, doFullDepthSearch, moveCountPruning, skipQuiets, ttCapture, pvExact;
...
//		maxValue = VALUE_INFINITE;
	...
	moves_loop:
		...
		while ((move = mp.next_move(skipQuiets)) != MOVE_NONE)
		{
			...
			valuableCaptureOrPawnPromotion = pos.valuable_capture_or_pawn_promotion(move);
	...
	//			&& pos.non_pawn_material(pos.side_to_move())
				...
				&& (!captureOrPawnPromotion || moveCountPruning))
			{
				...
				if (valuableCaptureOrPawnPromotion) // ~5 Elo
